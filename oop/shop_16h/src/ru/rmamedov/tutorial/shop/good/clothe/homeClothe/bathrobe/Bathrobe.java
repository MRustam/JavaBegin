...
public class Bathrobe extends HomeClose {
    ...
    public Bathrobe(String name, int price, int varrenty, Department department, String madeInContry, String color, String material) {
        super(name, price, varrenty, department, madeInContry, color, material);
    }
}